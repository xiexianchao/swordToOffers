...
2. Problem49 丑数    剑指
3. Problem51 数组中的逆序对数 github大神编码 剑指offer思想    
4. Problem52 两个链表的第一个节点   leetcode大神   
5. Problem53 在排序数组中查找数字  剑指
6. Problem53_1 0-n-1中缺失的数字 剑指
7. Problem55_1 求二叉平衡树是否平和，剑指 and github大神
8. Problem56 数组中数字出现的次数 他都出现两次，有两个元素出现一次，找出这两个元素，要求时间复杂度为n，空间复杂度为1   剑指
9. Problem56_1 数组中唯一出现一次的数字,其它数字都出现n次   时间复杂度为n，空间复杂度为1     剑指
10. Problem57 递增数组中和为s的两个数字   剑指   